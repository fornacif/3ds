        ...
        <div class="footer-columns-grid">
          <div class="footer-column">
            ...
            <ul class="footer-links">
              <li><a href="#" class="footer-link">Product Suite</a></li>
              <li><a href="#" class="footer-link">Enterprise Solutions</a></li>
              <li><a href="#" class="footer-link">Design Tools</a></li>
              <li><a href="#" class="footer-link">Analytics Platform</a></li>
              <li><a href="#" class="footer-link">Integration Tools</a></li>
            </ul>
          </div>
          <div class="footer-column">
            ...
            <ul class="footer-links">
              ...
              <li><a href="#" class="footer-link">Manufacturing</a></li>
              <li><a href="#" class="footer-link">Quality Management</a></li>
      ...
      <div class="footer-bottom">
        <div class="footer-bottom-left">
          ...
          <div class="footer-legal-links">
            ...
            <a href="#" class="footer-legal-link">Legal Notice</a>
          </div>
        </div>
        <div class="footer-social">
          ...
          <a href="#" class="footer-social-link" aria-label="Twitter" target="_blank" rel="noopener">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="#" class="footer-social-link" aria-label="GitHub" target="_blank" rel="noopener">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
